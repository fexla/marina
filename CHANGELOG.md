...
> 相对 0.3.3 的主题版本:**安卓远程客户端首批 + Linux 发布全自动** —— ADR-042
> Capacitor 远程壳与移动端适配第一版;FEX shell runner 原生构建、verify 门禁
> (含 libnode 检查)与 Linux 先发发布;Electron 33.4.11(修运行时堆破坏)与
> node-pty 编译修复。
